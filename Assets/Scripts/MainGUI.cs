...
public class MainGUI : MonoBehaviour {
	...
	void OnGUI () {
		...
		GUI.DrawTextureWithTexCoords (pixelExpBar , expBarTexture, new Rect (0, 0.75F, 1, 0.25F));
		GUI.DrawTextureWithTexCoords (RectSqueeseLeft(pixelExpBar, expPercent), expBarTexture, new Rect (0, 0.5F, expPercent, 0.25F));
		GUI.DrawTextureWithTexCoords (RectSqueeseRight(pixelExpBar, expPercent), expBarTexture, new Rect (expPercent, 0.25F, 1 - expPercent, 0.25F));
	}
